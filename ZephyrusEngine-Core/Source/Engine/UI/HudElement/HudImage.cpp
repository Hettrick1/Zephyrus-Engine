...
namespace Zephyrus::UI {
    HudImage::HudImage(ISceneContext* pContext, Assets::ITexture* pTexture, const Vector2D& pPosition, const Vector2D& pSize, const Vector2D& pOrigin)
    ...
    void HudImage::SetTexture(Assets::ITexture* pTexture)
    {
        mTexture = pTexture;
    }
