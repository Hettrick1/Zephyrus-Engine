...
void SplashScreen::Start()
{
	...
	mZephyrusText = new Zephyrus::UI::HudText("Zephyrus", Vector2D(0), 2.0f, Vector4D(1.0, 0.81176f, 0.0, 0.0), Zephyrus::UI::TextAlignment::CENTER, AssetsManager::LoadFont("Chopsic.otf", "Chopsic"));
	mZephyrusText->SetShaderProgram(AssetsManager::LoadShaderProgram({ &vert, &frag }, "splashScreenSP"));

	mStudioText = new Zephyrus::UI::HudText("Engine", Vector2D(0.0f, -200.0f), 0.5f, Vector4D(1, 1, 1, 0), Zephyrus::UI::TextAlignment::CENTER, AssetsManager::LoadFont("Chopsic.otf", "Chopsic"));
