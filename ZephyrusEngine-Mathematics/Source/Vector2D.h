...
struct Vector2D
{
	...
	Vector2D(int pX, int pY): x(static_cast<float>(pX)), y(static_cast<float>(pY)){}
	Vector2D(unsigned int pX,unsigned int pY): x(static_cast<float>(pX)), y(static_cast<float>(pY)){}
